...
testWidgets('should display name portrait screen scaffold widget exists',
      ...
      final scaffoldFinder = find.byKey(const Key('displayname_scaffold_portrait'));
      expect(scaffoldFinder, findsOneWidget);
    });
  });


  testWidgets('should display name portrait screen text one widget exists',
          (WidgetTester tester) async {
        await tester.pumpWidget(
          ProviderScope(
            child: CupertinoApp(
  ...
  testWidgets('should display name portrait screen text field widget exists',
        ...
        await tester.pumpAndSettle();
        final textFieldFinder = find.byKey(const Key('display_name_field_portrait'));
