  ...
  static final appThemeData = {
    AppTheme.darkTheme: const CupertinoThemeData(
      ...
      scaffoldBackgroundColor:
          Color(0xFF212121), // Negro para el fondo del scaffold
      ...
      textTheme: CupertinoTextThemeData(
        ...
        textStyle: TextStyle(
            color: Color.fromARGB(234, 247, 193, 68),
                ), // Naranja intenso para texto de acento
      ),
    ),
    AppTheme.lightTheme: const CupertinoThemeData(
      ...
      scaffoldBackgroundColor: Color.fromARGB(
          255, 255, 255, 255), // Blanco para el fondo del scaffold
