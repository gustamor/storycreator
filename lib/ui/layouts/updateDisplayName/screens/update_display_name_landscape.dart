...
class UpdateDisplayNameLandscapeScreen extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _UpdateDisplayNameLandscapeScreenState();
}

class _UpdateDisplayNameLandscapeScreenState
    extends ConsumerState<UpdateDisplayNameLandscapeScreen> {
            ...
            Form(
              ...
              child: Padding(
                ...
                child: CupertinoTextField(
                  ...
                  style:
                      TextStyle(fontSize: kIconTextFieldFontSizeLandscape.sp),
                  decoration: BoxDecoration(
                    borderRadius:
                        BorderRadius.circular(kIconTextFieldRadiusLandscape.w),
                    border: Border.all(
