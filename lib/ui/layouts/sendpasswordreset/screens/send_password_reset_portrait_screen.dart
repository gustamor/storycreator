...
class SendPasswordResetLinkPortraitScreen extends ConsumerStatefulWidget {
  const SendPasswordResetLinkPortraitScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SendPasswordResetLinkPortraitScreenState();
}

class _SendPasswordResetLinkPortraitScreenState
    extends ConsumerState<SendPasswordResetLinkPortraitScreen> {
  @override
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      key: const Key('resetpassword_scaffold_portrait'),
      navigationBar: CupertinoNavigationBar(
        leading: GestureDetector(
            key: const Key("resetpassword_gesture_portrait"),
            onTap: () {
        ...
        middle: const Text(
          ...
          key: Key("reset_password_title_portrait"),
        ),
      ),
      child: SingleChildScrollView(
        ...
        children: [
          Gap(196.h),
          Text(
            key: const Key('resetpassword_label_portrait'),
